/**
 * STELAR Locked Roster - OG Meta Handler
 */
...
export async function onRequest(context) {
    ...
    try {
        ...
        const title = "🔒 Locked Roster | STELAR Private Portfolio";
        const description = "🔒 Access your private watchlist and saved artist signals. STELAR's proprietary signal engine tracks your portfolio in real-time.";
